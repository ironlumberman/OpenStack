...
Requires(post):   units
Requires(preun):  units
Requires(postun): units
...
install -p -D -m 644 %{SOURCE10} /root/rpmbuild/BUILDROOT/%{name}-api.service
install -p -D -m 644 %{SOURCE11} /root/rpmbuild/BUILDROOT/%{name}-collector.service
install -p -D -m 644 %{SOURCE12} /root/rpmbuild/BUILDROOT/%{name}-compute.service
install -p -D -m 644 %{SOURCE13} /root/rpmbuild/BUILDROOT/%{name}-central.service
